...
const BasicSubscriptionCard = ({ onSubscribe }) => {
  return (
          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-2 justify-between">
              ...
              <div className="flex flex-col items-end">
                ...
                <div>
                  <span className="text-xl line-through text-gray-500">$19.99</span>
                </div>
                <div>
                  <span className="text-3xl font-bold gap-x-2 text-slate-300">$14.99</span>
                </div>
              </div>
            </div>
